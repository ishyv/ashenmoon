...
/** Defines how an item reacts to heat and ignition. */
export const FlammableSchema = z
  .object({
    ignitionTemp: z.number(),
    burnDurationSec: z.number(),
    transformsInto: z.string(),
  })
  .strict();

/** Defines an item's sensitivity to extreme high or low temperatures. */
export const TemperatureSensitiveSchema = z
  .object({
    maxSafeTemp: z.number(),
    minSafeTemp: z.number(),
    onExceeded: z.enum(["melt", "spoil", "ignite"]),
    transformsInto: z.string().optional(),
  })
  .strict();

/** Defines an item's natural decay rate and its spoiled product. */
export const DecayableSchema = z
  .object({
    lifespanSec: z.number(),
    transformsInto: z.string(),
  })
  .strict();
...
export const ItemDefSchema = z
  .object({
    ...
    flammable: FlammableSchema.optional(),
    temperatureSensitive: TemperatureSensitiveSchema.optional(),
    decayable: DecayableSchema.optional(),
  })
  .strict();
