<script lang="ts">
import { activeQuests, dialogueState } from "./quests.svelte";
import { devGiveItem, rpgState } from "./rpg-state.svelte";
import { playPickupSound, playCraftSound } from "./audio-synthesis";
